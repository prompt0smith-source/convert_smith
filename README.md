...
현재 오픈소스 기반 구현은 복잡한 PDF 내부 content stream을 Acrobat Pro처럼 완전히 재작성하지 않습니다. 안정성을 위해 수정 또는 삭제 대상 위치를 흰색 영역으로 가린 뒤 새 실제 PDF 텍스트를 다시 쓰는 방식을 사용합니다. 원본 PDF는 직접 수정하지 않습니다.
